...
print_slow(f"{red}\n")
print_slow(f"{green}I AM Hacker USER CHANEL TELEGRAM ME @iran hack ")
print_slow(f"{red}\n")
...
os.system("clear")
print_slow(f"{green}loading[■■■10%]\n")
os.system("clear")
print_slow(f"{red}loading[■■■■■40%]\n")
os.system("clear")
print_slow(f"{green}loading[■■■■■■■80%]\n")
os.system("clear")
print_slow(f"{red}loading[■■■■■■■■■■100%]\n")
os.system("clear")
print(f"{green}Wait . . . . . ")
...
def main():
    phone = str(input(f"{green}Enter phone number (+98xxxxxxx) : "))
    while True:
